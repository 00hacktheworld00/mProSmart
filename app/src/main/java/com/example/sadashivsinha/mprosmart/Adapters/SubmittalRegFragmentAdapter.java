 ...
 */
public class SubmittalRegFragmentAdapter  extends RecyclerView.Adapter<SubmittalRegFragmentAdapter.MyViewHolder> {
        ...
        public MyViewHolder(final View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(), SubmittalRegisterActivity.class);
    ...
    public SubmittalRegFragmentAdapter(List<MomList> momList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.title.setText("Submital Register # : ");
    }
