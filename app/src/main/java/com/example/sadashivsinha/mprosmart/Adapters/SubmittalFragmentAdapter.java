 ...
 */
public class SubmittalFragmentAdapter  extends RecyclerView.Adapter<SubmittalFragmentAdapter.MyViewHolder> {
        ...
        public MyViewHolder(final View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(), SubmittalActivity.class);
    ...
    public SubmittalFragmentAdapter(List<MomList> momList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.title.setText("Submittal # : ");
    }
