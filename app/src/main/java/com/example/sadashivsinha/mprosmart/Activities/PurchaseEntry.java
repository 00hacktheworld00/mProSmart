            ...
            case FILE_SELECT_CODE:
                try {
                    ...
                    // File
                        ...
                        Toast.makeText(PurchaseEntry.this, "File Selected : "+ path, Toast.LENGTH_SHORT).show();
                        if(path!=null)
                        {
                            ...
                            mainLayout2.addView(myButton, lp);

                            final String finalPath = path;
                            myButton.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    mainLayout2.removeView(myButton);
                                    attachmentNo--;
                                    Toast.makeText(PurchaseEntry.this, "File Removed :" + finalPath, Toast.LENGTH_SHORT).show();
