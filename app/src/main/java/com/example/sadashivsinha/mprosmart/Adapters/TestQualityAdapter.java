...
import com.example.sadashivsinha.mprosmart.Activities.TestAttachmentActivity;
 ...
 */
public class TestQualityAdapter extends RecyclerView.Adapter<TestQualityAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final View view) {
            ...
            attachBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(), TestAttachmentActivity.class);
                    itemView.getContext().startActivity(intent);
                }
            });
        }
    }
    public TestQualityAdapter(List<QualityList> qualityList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.test_card_view_quality, parent, false);
