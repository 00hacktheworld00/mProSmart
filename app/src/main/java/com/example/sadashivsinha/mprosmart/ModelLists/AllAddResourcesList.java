...
public class AllAddResourcesList {
    String sl_no, res_id, res_name, res_type, designation, email, phone, rate_per_hour, currency,subContractor;

    public AllAddResourcesList(String sl_no, String res_id, String res_name, String res_type, String subContractor,
