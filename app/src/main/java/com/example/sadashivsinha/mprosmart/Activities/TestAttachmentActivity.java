...
public class TestAttachmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setLayout(R.dimen._200sdp,R.dimen._200sdp);
        ...
        attachBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TestAttachmentActivity.this, "Uploaded Attachments", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
        addMoreBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    if (ContextCompat.checkSelfPermission(TestAttachmentActivity.this,
                            Manifest.permission.READ_EXTERNAL_STORAGE)
                            != PackageManager.PERMISSION_GRANTED)
                    {

                        ActivityCompat.requestPermissions(TestAttachmentActivity.this,
...
//                                    attachmentNo--;
//                                    Toast.makeText(TestAttachmentActivity.this, "File Removed :" + finalPath, Toast.LENGTH_SHORT).show();
//
//                                }
//                            });
//
