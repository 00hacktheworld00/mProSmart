 ...
 */
public class ResourceFragmentAdapter  extends RecyclerView.Adapter<ResourceFragmentAdapter.MyViewHolder> {
        ...
        public MyViewHolder(final View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(), ResourceTimesheetActivity.class);
    ...
    public ResourceFragmentAdapter(List<MomList> momList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.title.setText("Resource Timesheet # : ");
    }
