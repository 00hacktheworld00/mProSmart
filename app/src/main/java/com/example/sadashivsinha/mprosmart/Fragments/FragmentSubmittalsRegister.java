...
import com.example.sadashivsinha.mprosmart.Adapters.SubmittalRegFragmentAdapter;
 ...
 */
public class FragmentSubmittalsRegister extends Fragment {

    private List<MomList> momList = new ArrayList<>();
    private RecyclerView recyclerView;
    private SubmittalRegFragmentAdapter fragmentsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fragmentsAdapter = new SubmittalRegFragmentAdapter(momList);
