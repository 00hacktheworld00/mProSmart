 ...
 */
public class MomFragmentsAdapter extends RecyclerView.Adapter<MomFragmentsAdapter.MyViewHolder> {

    private List<MomList> momList;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView text_mom_rec, text_project_id, text_project_name, text_date, text_created_by;
        ...
        public MyViewHolder(final View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(), MomActivity.class);
    ...
    public MomFragmentsAdapter(List<MomList> momList) {
