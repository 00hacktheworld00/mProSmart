...
public class BudgetMainActivity extends NewActivity implements View.OnClickListener {

    CardView card_budget_transfer, card_budget_changes, card_expense;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Budget & Expense Management");
        ...
        if (!isInternetPresent) {
            ...
            Crouton.makeText(BudgetMainActivity.this, R.string.no_internet_error, Style.ALERT, main_layout).show();
        }
...
//        pDialog.show();
    ...
    private void prepareHeader()
    {
        ...
        if(!imageUrl.equals(""))
        {
            Glide.with(BudgetMainActivity.this)
                    .load(imageUrl)
                    .crossFade()
                    .into(company_logo);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            {
                Intent intent = new Intent(BudgetMainActivity.this, AllBudgetChanges.class);
                startActivity(intent);
            }
            break;
            case R.id.card_budget_transfer:
            {
                Intent intent = new Intent(BudgetMainActivity.this, AllBudgetTransfer.class);
                startActivity(intent);
            }
            break;
            case R.id.card_expense:
            {
                Intent intent = new Intent(BudgetMainActivity.this, AllExpenses.class);
                startActivity(intent);
            }
            break;
        }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(BudgetMainActivity.this, MainCategories.class);
        startActivity(intent);
