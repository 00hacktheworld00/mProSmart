...
import com.example.sadashivsinha.mprosmart.Adapters.ResourceFragmentAdapter;
 ...
 */
public class FragmentResourceTimesheet  extends Fragment {

    private List<MomList> momList = new ArrayList<>();
    private RecyclerView recyclerView;
    private ResourceFragmentAdapter fragmentsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fragmentsAdapter = new ResourceFragmentAdapter(momList);
